...
class MicrosoftSSOProvider(SSOProvider):
    ...
    def __init__(
        self, client_id: str, client_secret: str, redirect_uri: str, tenant: str = "common"
    ):
        super().__init__(client_id, client_secret, redirect_uri)
        self.tenant = tenant
...
class OktaSSOProvider(SSOProvider):
    ...
    async def exchange_code(self, code: str, state: str) -> Dict[str, Any]:
        ...
        data = {"code": code, "redirect_uri": self.redirect_uri, "grant_type": "authorization_code"}
...
class RBACManager:
    ...
    def __init__(self):
        ...
        self.roles: Dict[str, Dict[str, Any]] = {
            ...
            "viewer": {
                ...
                "permissions": ["profile.read", "data.read"],
            },
        }
    ...
    def create_custom_role(self, role_name: str, description: str, permissions: List[str]) -> bool:
        """Create custom role"""
