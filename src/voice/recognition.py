...
class VoiceRecognition:
    ...
    def __init__(self, wake_words=None, continuous_mode=True, always_active=True):
        ...
        self.exit_words = [
            "sleep", "go to sleep", "stop listening", "pause", "that's all", "thanks", "thank you"
        ]
            ...
            try:
                with self.microphone as source:
                    ...
                    try:
                        ...
                        if self.continuous_mode and not self.always_active and self.active_session and self.last_command_time:
                        ...
                        # In always_active mode OR (continuous mode and active session), treat everything as command
                            ...
                            self.logger.info(f"Command ({'always active' if self.always_active else 'continuous mode'}): {text}")
