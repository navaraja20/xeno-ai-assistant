...
class JobAutomation:
    ...
    def search_indeed(
        self, job_title: str, location: str = "", max_results: int = 20
    ) -> List[Dict]:
        """
        ...
        try:
            ...
            # Build search URL
            params = {"q": job_title, "l": location, "sort": "date"}
    ...
    def search_linkedin(
        ...
        try:
            ...
            # LinkedIn jobs URL
            params = {"keywords": job_title, "location": location, "sortBy": "DD"}  # Sort by date
            ...
            for card in job_cards[:max_results]:
                try:
                    ...
                    company_elem = card.find(
                        "h4", class_=re.compile(r"job-search-card__company-name")
                    )
    ...
    def search_all_platforms(
        self, job_title: str, location: str = "", max_per_platform: int = 10
    ) -> List[Dict]:
        """
    ...
    def filter_jobs(
        self, jobs: List[Dict], keywords: List[str] = None, exclude_keywords: List[str] = None
    ) -> List[Dict]:
        """
    ...
    def get_job_details(self, job_url: str) -> Optional[Dict]:
        ...
        try:
            ...
            description_elem = soup.find(
                "div", class_=re.compile(r"jobsearch-jobDescriptionText|description")
            )
    ...
    def save_job(self, job: Dict, database_session) -> bool:
        ...
        try:
            ...
            existing = (
                database_session.query(JobApplication).filter_by(url=job.get("url", "")).first()
            )
    ...
    def update_job_status(
        self, database_session, job_id: int, status: str, notes: str = ""
    ) -> bool:
        """
        ...
        try:
            ...
            if notes:
                ...
                job.extra_data["notes"].append({"date": datetime.now().isoformat(), "text": notes})
