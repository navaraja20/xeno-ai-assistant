...
class GitHubManager:
    ...
    def update_readme(
        self, repo_name: str, content: str, commit_message: str = "Update README"
    ) -> bool:
        """
        ...
        try:
            ...
            try:
                ...
                repo.update_file(
                    path="README.md", message=commit_message, content=content, sha=readme.sha
                )
            except GithubException:
                # README doesn't exist, create it
                repo.create_file(path="README.md", message=commit_message, content=content)
    ...
    def search_repositories(
        self, query: str, language: str = None, max_results: int = 20
    ) -> List[Dict]:
        """
