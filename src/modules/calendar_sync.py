...
class CalendarSync:
    ...
    def update_event(self, event_id: str, **kwargs) -> bool:
        ...
        try:
            ...
            if "start_time" in kwargs:
                event["start"] = {"dateTime": kwargs["start_time"].isoformat(), "timeZone": "UTC"}
            if "end_time" in kwargs:
                event["end"] = {"dateTime": kwargs["end_time"].isoformat(), "timeZone": "UTC"}
    ...
    def create_reminder(
        self, title: str, reminder_time: datetime, description: str = ""
    ) -> Optional[str]:
        """
