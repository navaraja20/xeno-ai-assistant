...
class ContextualAIChat:
    ...
    def __init__(self, config=None, email_handler=None, github_manager=None, linkedin_automation=None):
        """
    ...
    def _gather_context(self, message: str) -> Dict[str, Any]:
        ...
        # GitHub context
        if any(word in message_lower for word in ['github', 'repo', 'repository', 'code', 'pull request', 'pr']):
...
Provide concise, actionable responses."""
        ...
        full_message = f"{system_prompt}{context_str}\n\nConversation:{history_str}\n\nUser: {message}\nXENO:"
        return full_message
