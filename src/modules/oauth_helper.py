...
class OAuthHelper:
    ...
    def start_callback_server(self):
        ...
        try:
            self.server = socketserver.TCPServer(("localhost", self.redirect_port), OAuthHandler)
    ...
    def authenticate_google(
        self, client_id: str, client_secret: str, scopes: list = None
    ) -> Optional[Dict]:
        """
        ...
        try:
            ...
            return {"code": auth_code, "client_id": client_id, "client_secret": client_secret}
