...
class CredentialsPage(QWizardPage):
    ...
    def _open_github_oauth(self):
        ...
        webbrowser.open(
            "https://github.com/settings/tokens/new?description=XENO%20AI%20Assistant&scopes=repo,user,read:org"
        )
...
class SetupWizard(QWizard):
    ...
    def get_config(self) -> Dict[str, Any]:
        ...
        config = {
            ...
            "ai": {
                "provider": "openai"
                if "openai" in ai_page.ai_provider.currentText().lower()
                else "gemini",
    ...
    def accept(self):
        ...
        from utils.system import create_desktop_shortcut, mark_first_run_complete
