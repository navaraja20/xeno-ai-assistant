...
class TrainingWorker(QThread):
    ...
    def run(self):
        try:
            ...
            result = {"success": True, "accuracy": 0.95, "loss": 0.05}
...
class ModelFineTuningUI(QWidget):
    ...
    def create_performance_tab(self) -> QWidget:
        ...
        self.metrics_table.setHorizontalHeaderLabels(["Metric", "Current", "Average", "Trend"])
        ...
        self.ab_table.setHorizontalHeaderLabels(["Test Name", "Variant A", "Variant B", "Winner"])
