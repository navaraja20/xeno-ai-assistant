...
class SlackIntegration(IntegrationBase):
    ...
    async def upload_file(self, channels: str, file_path: str, title: Optional[str] = None,
    ...
    async def set_status(self, status_text: str, status_emoji: str = ':speech_balloon:',
