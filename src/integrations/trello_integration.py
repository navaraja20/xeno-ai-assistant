...
class TrelloIntegration(IntegrationBase):
    ...
    async def create_board(
        self, name: str, desc: Optional[str] = None, default_lists: bool = True
    ) -> Dict[str, Any]:
        """Create a new board"""
        params = {"name": name, "defaultLists": default_lists}
    ...
    async def add_attachment(
        self, card_id: str, url: str, name: Optional[str] = None
    ) -> Dict[str, Any]:
    ...
    async def set_due_date(
        self, card_id: str, due: str, due_complete: bool = False
    ) -> Dict[str, Any]:
        """Set card due date"""
        params = {"due": due, "dueComplete": due_complete}
