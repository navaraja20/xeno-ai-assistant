...
class DiscordIntegration(IntegrationBase):
    ...
    async def send_message(
        self, channel_id: str, content: str, embed: Optional[Dict] = None, tts: bool = False
    ) -> Dict[str, Any]:
    ...
    async def create_channel(
        ...
        payload = {"name": name, "type": channel_type}  # 0=text, 2=voice, 4=category
    ...
    async def create_thread(
        self, channel_id: str, message_id: str, name: str, auto_archive_duration: int = 1440
    ) -> Dict[str, Any]:
