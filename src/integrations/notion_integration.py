...
class NotionIntegration(IntegrationBase):
    ...
    async def create_page(self, parent_id: str, title: str, properties: Optional[Dict] = None,
    ...
    async def _api_call(self, method: str, endpoint: str, data: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
