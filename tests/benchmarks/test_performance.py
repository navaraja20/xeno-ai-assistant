...
def test_team_task_workflow_performance(benchmark):
    ...
    from src.collaboration.team_features import TaskDelegationManager, TeamManager
    ...
    def workflow():
        ...
        team_mgr.create_team(
            team_id=team_id, name=f"Team {team_id}", description="Benchmark team", owner="owner"
        )
