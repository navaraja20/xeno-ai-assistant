...
async def test_voice_engine_process_audio_mock():
    ...
    with patch.object(
        engine.stt, "recognize", return_value=("Hello XENO", Language.ENGLISH_US, 0.9)
    ):
